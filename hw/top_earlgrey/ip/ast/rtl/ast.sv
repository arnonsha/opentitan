...
`endif
  ...
  // clock glitch alert
  input cg_alert_trig_i,                      // Clock Glitch Alert Trigger
  input cg_alert_ack_i,                       // Clock Glitch Alert Acknowlage
  output logic cg_alert_po,                   // Clock Glitch Alert Positive
  output logic cg_alert_no,                   // Clock Glitch Alert Negative

  // glitch detect alert
  input gd_alert_trig_i,                      // Glitch Detect Alert Trigger
  input gd_alert_ack_i,                       // Glitch Detect Alert Acknowlage
  output logic gd_alert_po,                   // Glitch Detect Alert Positive
  output logic gd_alert_no,                   // Glitch Detect Alert Negative

  // temp sense high alert
  input ts_alert_hi_trig_i,                   // Temp Sense High Alert Trigger
  input ts_alert_hi_ack_i,                    // Temp Sense High Alert Acknowlage
  output logic ts_alert_hi_po,                // Temp Sense High Alert Positive
  output logic ts_alert_hi_no,                // Temp Sense High Alert Negative

  // temp sense low alert
  input ts_alert_lo_trig_i,                   // Temp Sense Low Alert Trigger
  input ts_alert_lo_ack_i,                    // Temp Sense Low Alert Acknowlage
  output logic ts_alert_lo_po,                // Temp Sense Low Alert Positive
  output logic ts_alert_lo_no,                // Temp Sense Low Alert Negative

  // light sense alert
  input ls_alert_trig_i,                      // Liht Sense Alert Trigger
  input ls_alert_ack_i,                       // Liht Sense Alert Acknowlage
  output logic ls_alert_po,                   // Liht Sense Alert Positive
  output logic ls_alert_no,                   // Liht Sense Alert Negative

  // other alert
  input ot_alert_trig_i,                      // OTher Alert Trigger
  input ot_alert_ack_i,                       // OTher Alert Acknowlage
  output logic ot_alert_po,                   // OTher Alert Positive
  output logic ot_alert_no,                   // OTher Alert Negative
...
`ASSERT_KNOWN(AsAlertPKnownO_A, as_alert_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(AsAlertNKnownO_A, as_alert_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(CgAlertPKnownO_A, cg_alert_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(CgAlertNKnownO_A, cg_alert_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(GdAlertPKnownO_A, gd_alert_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(GdAlertNKnownO_A, gd_alert_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(TsAlertHiPKnownO_A, ts_alert_hi_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(TsAlertHiNKnownO_A, ts_alert_hi_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(TsAlertLoPKnownO_A, ts_alert_lo_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(TsAlertLoNKnownO_A, ts_alert_lo_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(LsAlertPKnownO_A, ls_alert_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(LsAlertNKnownO_A, ls_alert_no, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(OtAlertPKnownO_A, ot_alert_po, clk_ast_alert_i, rst_ast_alert_ni)
`ASSERT_KNOWN(OtAlertNKnownO_A, ot_alert_no, clk_ast_alert_i, rst_ast_alert_ni)
